...
export function createApp(){
 ...
 app.get("/",(req,res)=>res.json({success:true,message:"CarePulse API"}));app.get("/health",(req,res)=>res.json({success:true,data:{status:"healthy",timestamp:new Date().toISOString()}}));
